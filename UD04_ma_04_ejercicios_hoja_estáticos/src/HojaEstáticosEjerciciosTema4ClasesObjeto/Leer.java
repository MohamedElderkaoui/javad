...
Utilidad sUtilidad;
	...
	public static int leer_opcion_menu(String str_mi, String[] menu) {
		...
		} while (numero_rango(menu, opcion));
		return opcion;
	}
	public static int leer_opcion_menu2(String str_mi, String[] menu) {
		int opcion = -1;
		String[] menu2 = menu;
		//Comparator<String> c = (a, b) -> a.length() - b.length();
		//Arrays.sort(menu2, c.reversed());
	 ...
	 * @return
	 */
	public static boolean numero_rango(String[] menu, int opcion) {
		return opcion > -1 && opcion >menu.length;
	}
